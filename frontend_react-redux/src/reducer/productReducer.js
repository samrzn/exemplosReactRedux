...
const initialSt = {
    ...
    allProducts: [
        ...
        },
        {
            ...
            descricao: "Teclado Razer Huntsman Tournament Edition",
            valor: "R$ 1.399,00",
            desconto: "R$ 1.049,00"
        },
        {
        ...
        },
        {
            ...
            descricao: "Memória Kingston Fury Beast, 32GB (2x16GB), 6000MHz, DDR5, CL40",
            valor: "R$ 3.101,09",
            desconto: "R$ 2.449,90"
        },
        {
        ...
        },
        {
            ...
            descricao: "Cadeira de Escritório Husky Office 700, Preto",
            valor: "R$ 2.842,05",
            desconto: "R$ 2.099,90"
        },
        {
...
export const productReducer = createReducer(initialSt, (builder) => {
    builder
